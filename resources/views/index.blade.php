...
<title>
    The Farewell Guide – Compliance Check (Auto)
</title>
...
<h1>
    The Farewell Guide – Compliance Check
</h1>


<p class="subtitle">
    Type a name → auto-check → review → export.
    Google link & score are mandatory.
</p>
...
<input
    id="autoQuery"
    type="text"
    placeholder="e.g., A J Brooke, Ascot"
/>
...
<strong>
    Select correct match (VERY IMPORTANT)
</strong>
...
<h2>
    C) Reviews & Public Sentiment (Required)
</h2>
...
<h2>
    D) Companies House & Corporate Status
</h2>
...
<option value="proposal to strike off">
...
<h2>
    E) CMA Order (2021) – Price Transparency
</h2>
...
Standardised Price List (SPL) URL
...
Sell/arrange funeral plans?


<select id="fcaDoPlans">
...
Authorisation email on file?


<select id="authOnFile">
